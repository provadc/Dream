...
$conta=$row["conta"]; 
$sql = "SELECT Num_Telaio, marca, modello, prezzo, Immagine FROM Auto WHERE nuova=0 AND Num_Telaio NOT IN(select Num_Telaio from StoricoVendite) LIMIT 10 OFFSET ". ($pagina-1)*10;
